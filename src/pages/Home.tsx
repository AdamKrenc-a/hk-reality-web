...
import { Calculator, Home as HomeIcon, Settings, MessageSquare, CheckCircle2, Phone, Mail, ArrowRight } from 'lucide-react'
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/sluzby/ocenovani" className="btn-secondary bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white hover:text-primary text-lg px-8 py-4">
                  Odhad zdarma
                </Link>
              </div>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a href="tel:+420123456789" className="btn-accent text-lg px-8 py-4 inline-flex items-center justify-center gap-2">
