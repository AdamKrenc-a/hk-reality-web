...
const contactInfo = [
  {
    ...
    title: 'Telefon',
    items: [
      { label: 'Michaela Hudská', value: '+420 725 212 850' },
      { label: 'Adam Krenc', value: '+420 605 822 363' },
    ],
  },
  {
    icon: Mail,
    title: 'Email',
    items: [
      { label: 'Michaela Hudská', value: 'mhudska@email.cz' },
      { label: 'Adam Krenc', value: 'adamkrenc4@gmail.com' },
    ],
  },
  {
    icon: MapPin,
    title: 'Působnost',
    items: [
      { label: 'Hlavní oblast', value: 'Ústecký kraj' },
    ],
  },
  {
    icon: Clock,
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setSubmitError(result.error || 'Neznámá chyba při odesílání')
      }
    } catch (error) {
      console.error('Chyba při odesílání formuláře:', error)
      setSubmitError('Neznámá chyba při odesílání formuláře')
    } finally {
            ...
            >
              ...
              {submitError && (
                ...
                >
                  ...
                  <div>
                    <p className="text-red-700 font-medium">Chyba při odesílání zprávy</p>
